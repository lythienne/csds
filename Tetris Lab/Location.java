...
public class Location implements Comparable
{
    ...
    /**
     * Sets the row coordinate to a new coordinate
     * @param newRow the new coordinate
     */
    ...
    /**
     * Sets the column coordinate to a new coordinate
     * @param newCol the new coordinate
     */
